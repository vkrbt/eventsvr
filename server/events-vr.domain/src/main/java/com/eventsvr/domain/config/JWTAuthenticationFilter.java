...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    private static final String SECRET = "PETYA ";
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            EventsVrUser creds = new ObjectMapper()
                    .readValue(req.getInputStream(), EventsVrUser.class);
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        res.getWriter().write("{\"Authorization\" : \"" + SECRET + token + "\"," +
                " \"name\" : " + ((User) auth.getPrincipal()).getUsername() + "}");
    }
}